...
<section class="container">
	...
	<div class="form-group row">
		...
		<label class="col-sm-3"><h1>Event anzeigen</h1></label>

		<div class="col-sm-2"> 
			<button class='btn btn-primary' id="1" onclick="load( {{$event->id}}, this.id)">Rechnung hinzufuegen</button>
		</div>

		<div class="col-sm-2"> 
			<button class='btn btn-primary' id="2" onclick="load( {{$event->id}}, this.id)">Teilnehmer hinzufuegen</button>
		</div>
	...
	<div class="form-group row">
	<label class="col-sm-1 col-form-label"><h1>Teilnehmer</h1></label>
